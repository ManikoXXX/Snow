...
function setup() {
  ...
  snowBall = Bodies.circle(1000,1000,10);
...
slingShot = new SlingShot(this.snowBall,{x:350,y:548});
}
...
function draw() {
  ...
  imageMode(CENTER)
  image(snowBallImg ,snowBall.position.x,snowBall.position.y,115,60);
  for(var i = 0; i<maxFlakes; i++){
    flakes[i].showFlake();
    flakes[i].updateY();
}
